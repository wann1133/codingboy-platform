...
const CreateBlogPage = () => {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setNotice('Artikel baru berhasil dibuat. Mengarahkan ke daftar blog...');
      setTimeout(() => {
      ...
      <div className="mx-auto flex max-w-4xl flex-col gap-8 px-6">
        <header className="flex flex-col gap-4">
          ...
          <div>
            ...
            <h1 className="mt-4 text-3xl font-semibold text-white">Tambah artikel baru</h1>
            <p className="mt-2 max-w-2xl text-sm text-slate-400">
              Siapkan konten blog terbaru lengkap dengan metadata agar langsung siap publish.
            </p>
          </div>
        </header>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  {isSubmitting ? 'Menyimpan...' : 'Publish ke staging'}
                </button>
              </div>
            </div>
